...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__polyfill__ = __webpack_require__(443);
...
var context = __webpack_require__(444); // Import.
...
var map = {
	"./accordion/frontend.js": 445,
	"./buttons/frontend.js": 446,
	"./gallery01/frontend.js": 447,
	"./generic-slider/frontend.js": 448,
	"./gift-slider/frontend.js": 449,
	"./hero-slider/frontend.js": 450,
	"./image-text-grid/frontend.js": 451,
	"./number-counter/frontend.js": 452,
	"./two-tone-text/frontend.js": 453,
	"./video-popup/frontend.js": 454
};
...
Object(__WEBPACK_IMPORTED_MODULE_0__wordpress_dom_ready__["a" /* default */])(function () {
  ...
  if (typeof jQuery.fn.slick === 'function' && $sliders.length) {
    $sliders.each(function (i, item) {
      ...
      jQuery(item).find('.rri-hero-slider__inner').slick(settings); // Change handlers
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_bigpicture__ = __webpack_require__(455);
