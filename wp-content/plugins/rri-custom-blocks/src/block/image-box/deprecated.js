...
{ [ 1, 2, 3, 4 ].forEach( i => {
    deprecatedSchema_1_17_3[ `title${ i }` ] = {
        source: 'html',
        selector: `.rri-image-box__item:nth-of-type(${ i }) .rri-image-box__title`,
        default: __( 'Title', i18n ),
    }
    deprecatedSchema_1_17_3[ `description${ i }` ] = {
        source: 'html',
        selector: `.rri-image-box__item:nth-of-type(${ i }) .rri-image-box__description`,
    ...
    deprecatedSchema_1_17_3[ `link${ i }` ] = {
        type: 'string',
        source: 'attribute',
        selector: `.rri-image-box__item:nth-of-type(${ i }) .rri-image-box__overlay`,
        attribute: 'href',
        default: '',
    }
...
const deprecatedSave_1_17_3 = props => {
    ...
    const mainClasses = classnames( [
        ...
        [ `rri-image-box--design-${ design }` ]: design !== 'basic',
        [ `rri-image-box--effect-${ imageHoverEffect }` ]: imageHoverEffect,
        [ `rri-image-box--overlay-${ overlayOpacity }` ]: overlayOpacity !== 7,
        'rri-image-box--arrow': arrow,
    }, design, props ) )
        ...
        <div className={ mainClasses } style={ mainStyles }>
            ...
            { range( 1, columns + 1 ).map( i => {
                ...
                const arrowClasses = classnames( [
                    ...
                    `rri-image-box__arrow--align-${ arrow }`,
                ] )

                return (
                    <div className={ boxClasses } style={ boxStyles } key={ i }>
                        { imageHoverEffect && <div
                            className="rri-image-box__image-effect"
                            style={ {
                                backgroundImage: imageURL ? `url(${ imageURL })` : undefined,
                            } } />
                        }
                        ...
                        <a
                            className="rri-image-box__overlay"
                            href={ link }
...
{ [ 1, 2, 3, 4 ].forEach( i => {
    deprecatedSchema_1_10[ `title${ i }` ] = {
        source: 'html',
        selector: `.rri-image-box-wrapper > *:nth-child(${ i }) h4`,
        default: 'Title',
    }
    deprecatedSchema_1_10[ `description${ i }` ] = {
        source: 'html',
        selector: `.rri-image-box-wrapper > *:nth-child(${ i }) p`,
        default: 'Description',
    }
    ...
    deprecatedSchema_1_10[ `link${ i }` ] = {
        type: 'string',
        source: 'attribute',
        selector: `.rri-image-box-wrapper > *:nth-child(${ i }) a`,
        attribute: 'href',
    }
} ) }
    ...
    return (
        <div className={ mainClasses } style={ mainStyles }>
            { range( 1, columns + 1 ).map( i => {
                ...
                return (
                    <div className="rri-image-box" style={ boxStyles } key={ i }>
                        { /* eslint-disable-next-line */ }
                        <a href={ link } />
                        { ! RichText.isEmpty( title ) && (
                            <RichText.Content
...
export const deprecatedSave_1_1_2 = props => {
    ...
    return (
        <div className={ `rri-image-box ${ imageClass } ${ displayNone } ${ fullWidth }` }
             data-url={ url }
             style={ {
                 width: width + 'px',
                 height: height + 'px',
...
const migrate_1_17_3 = attributes => {
    ...
    const updateCSS = css => ( css || '' )
        .replace( /\.rri-image-box__overlay(\s*{)/g, '.rri-image-box__overlay-hover$1' )
