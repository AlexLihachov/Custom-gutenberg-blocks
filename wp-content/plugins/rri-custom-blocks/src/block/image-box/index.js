...
export const schema = {
	...
	...createAllCombinationAttributes(
		'link%sUrl', {
			...
			default: '',
			source: 'attribute',
			selector: '.rri-image-box__item%d .rri-image-box__overlay-link',
			attribute: 'href',
		},
		['1', '2', '3', '4']
	),
	...
	...createAllCombinationAttributes(
		'subtitle%s', {
			type: 'string',
			source: 'html',
			selector: '.rri-image-box__item%d .rri-image-box__subtitle',
	...
	...createAllCombinationAttributes(
		'title%s', {
			type: 'string',
			source: 'html',
			selector: '.rri-image-box__item%d .rri-image-box__title',
	...
	...createAllCombinationAttributes(
		'description%s', {
			type: 'string',
			source: 'html',
			selector: '.rri-image-box__item%d .rri-image-box__description',
...
export const name = 'rri/image-box';
...
addFilter('stackable.image-box.advanced-column-spacing.styles', 'stackable/image-box/column-height', styles => {
	styles['> .rri-inner-block > .rri-block-content > *'] = {
		minHeight: undefined,
	};
	styles.tablet['> .rri-inner-block > .rri-block-content > *'] = {
		minHeight: undefined,
	};
	styles.mobile['> .rri-inner-block > .rri-block-content > *'] = {
		minHeight: undefined,
	};
