	...
	return (
		<Fragment>
			...
			<PanelBody title={__('General', i18n)}>
				...
				>
					<AdvancedRangeControl
						...
						allowReset={true}
						placeholder="350"
						className="rri--help-tip-image-box-height"
					/>
				</ResponsiveControl>
				{show.borderRadius &&
				<AdvancedRangeControl
				...
				>
					<AdvancedToolbarControl
						...
						className="rri--help-tip-advanced-column-content-vertical-align"
					/>
				</ResponsiveControl>
				<ContentAlignControl
					setAttributes={setAttributes}
			...
			<PanelAdvancedSettings
				...
				className="rri--help-tip-image-box-overlay"
			>
				<BackgroundControlsHelper
				...
				<AdvancedRangeControl
					...
					allowReset={true}
					placeholder="0.7"
					className="rri--help-tip-background-color-opacity"
				/>
			</PanelAdvancedSettings>
			...
			<PanelAdvancedSettings
				...
				className="rri--help-tip-image-box-overlay-hover"
			>
				<BackgroundControlsHelper
			...
			>
				<SelectControl
					...
					className="rri--help-tip-image-box-hover-effect"
				/>
			...
			>
				...
				>
					<AlignButtonsControl
						label={__('Align', i18n)}
						className="rri--help-tip-image-box-subtitle-align"
					/>
				</ResponsiveControl>
			</PanelAdvancedSettings>
			...
			>
				...
				>
					<AlignButtonsControl
						label={__('Align', i18n)}
						className="rri--help-tip-image-box-title-align"
					/>
				</ResponsiveControl>
			</PanelAdvancedSettings>
			...
			>
				...
				>
					<AlignButtonsControl
						label={__('Align', i18n)}
						className="rri--help-tip-image-box-description-align"
					/>
				</ResponsiveControl>
			</PanelAdvancedSettings>
			...
			>
				...
				>
					<AlignButtonsControl
						label={__('Align', i18n)}
						className="rri--help-tip-image-box-arrow-align"
					/>
				</ResponsiveControl>
			</PanelAdvancedSettings>
				...
				{show.subtitleSpacing && (
					...
					>
						<AdvancedRangeControl
							...
							max={100}
							allowReset={true}
							className="rri--help-tip-image-box-subtitle-spacing"
						/>
					</ResponsiveControl>
				)}
				{show.titleSpacing && (
					...
					>
						<AdvancedRangeControl
							...
							max={100}
							allowReset={true}
							className="rri--help-tip-image-box-title-spacing"
						/>
					</ResponsiveControl>
				)}
				{show.lineSpacing && (
					...
					>
						<AdvancedRangeControl
							...
							max={100}
							allowReset={true}
							className="rri--help-tip-image-box-line-spacing"
						/>
					</ResponsiveControl>
				)}
				{show.descriptionSpacing && (
					...
					>
						<AdvancedRangeControl
							...
							max={100}
							allowReset={true}
							className="rri--help-tip-image-box-description-spacing"
						/>
					</ResponsiveControl>
				)}
				{show.arrowSpacing && (
					...
					>
						<AdvancedRangeControl
							...
							max={100}
							allowReset={true}
							className="rri--help-tip-image-box-arrow-spacing"
						/>
					</ResponsiveControl>
				)}
			</PanelSpacingBody>
							...
							>
								<div className="rri-image-box__box rri-image-box__image-wrapper">
									<ImageUploadPlaceholder
										...
										imageSize={imageSize}
										className="rri-image-box__box rri-image-box__image"
										onRemove={() => {
											setAttributes({
												[`image${i}Id`]: '',
												[`image${i}Url`]: '',
...
export default compose(
	...
	withClickOpenInspector([
		['.rri-image-box__title', 'title'],
		['.rri-image-box__subtitle', 'subtitle'],
		['.rri-image-box__description', 'description'],
		['.rri-image-box__arrow svg', 'arrow'],
	]),
