...
export const name = 'rri/container';
...
export const settings = {
	...
	supports: {
		...
		inserter: true, // Hide if disabled.
		...
		from: [
			{
				...
				__experimentalConvert(blocks) {
					// Avoid transforming a single `rri/container` Block
					if (blocks.length === 1 && blocks[0].name === 'rri/container') {
						return
					}
					...
					return createBlock('rri/container', {
