...
export const createStyles = props => {
	...
	if (show.borderRadius) {
		styles.push({
			[`.${uniqueClass}-wrapper.rri-container__wrapper`]: {
			...
			editor: {
				[`.${uniqueClass}-wrapper.rri-container__wrapper > .rri-video-background, ` +
				`.${uniqueClass}-wrapper.rri-container__wrapper:before`]: {
	...
	styles.push({
		'> .rri-inner-block > .rri-block-content > *': {
	...
	styles.push({
		[`.${uniqueClass}-wrapper > .rri-container__side`]: {
	...
	styles.push({
		[`.${uniqueClass}-content-wrapper.rri-container__content-wrapper`]: {
	...
	styles.push({
		...(show.columnBackground ? createBackgroundStyleSet('column%s', `${uniqueClass}-wrapper.rri-container__wrapper`, props.attributes, columnBackgroundOptions) : {}),
	});
