...
const deprecatedSave_1_15_6 = props => {
	...
	const mainClasses = classnames( [
		...
		'rri-video-popup',
		'rri-video-popup--v2',
		`rri-video-popup--design-${ design }`,
		`rri-video-popup--button-${ playButtonType }`,
		'rri--background-opacity-' + ( 1 * Math.round( backgroundOpacity / 1 ) ),
	], applyFilters( 'stackable.video-popup.mainclasses_1_15_6', {
		'rri--has-background': backgroundColor || backgroundImageURL,
		'rri--has-background-image': backgroundImageURL,
		[ `rri--shadow-${ shadow }` ]: design !== 'plain' && shadow !== 3,
	...
	return (
		<div className={ mainClasses } style={ mainStyle } data-video={ videoID }>
			...
			<div className="rri-video-popup__wrapper" >
...
const deprecatedSave_1_10 = props => {
	...
	return (
		<div className={ mainClasses } style={ mainStyle } data-video={ videoID }>
			<div className="rri-video-wrapper" >
				{ /* eslint-disable-next-line */ }
				<a href="#" />
				<span className="rri-play-button">
...
export const deprecatedSave_1_5 = props => {
	...
	return (
		<div className={ mainClasses }
			...
			<div className="rri-video-preview"
...
const deprecated = [
	{
		...
		migrate: attributes => {
			...
			const updateCSS = css => ( css || '' ).replace( /\.rri-video-popup([\s\{\[\.\#\:])/g, '.rri-video-popup__wrapper$1' )
