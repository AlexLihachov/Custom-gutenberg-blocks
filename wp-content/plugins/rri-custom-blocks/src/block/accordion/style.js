...
export const createStyles = props => {
	...
	styles.push({
		...(show.headerBackground ? createBackgroundStyleSet('container%s', 'rri-accordion__heading', props.attributes, columnBackgroundOptions) : {}),
	});
	...
	if (show.titleSpacing) {
		styles.push(...createResponsiveStyles('.rri-accordion.rri-accordion--open .rri-accordion__heading', 'title%sBottomMargin', 'marginBottom', '%spx', props.attributes, true))
	}
