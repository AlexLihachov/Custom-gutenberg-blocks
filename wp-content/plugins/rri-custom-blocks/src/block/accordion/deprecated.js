...
const deprecatedSchema_1_17_3 = {
	heading: {
		source: 'html',
		selector: '.rri-accordion__heading h4',
		default: __('Title for This Block', i18n),
	},
	text: {
		source: 'html',
		selector: '.rri-accordion__text',
...
const deprecatedSave_1_17_3 = props => {
	...
	const mainClasses = classnames([
		...
		[`rri-accordion--design-${design}`]: design !== 'basic',
...
const deprecatedSave_1_11 = props => {
	...
	const ArrowIcon = props => {
		return (
			<svg role="img" focusable="false" xmlns="http://www.w3.org/2000/svg" width="20" height="20"
...
const deprecatedSave_1_10 = props => {
	...
	return (
		<div className={mainClasses}>
			...
			<div className="rri-accordion__heading"
				 style={{
...
const deprecated = [
	{
		...
		migrate: attributes => {
			...
			const updateCSS = css => (css || '')
				.replace(/\n\.rri-accordion__heading h4(\s*{)/g, '\n.rri-accordion__title$1')
				.replace(/\.rri-accordion__text/g, '.rri-accordion__content')
				.replace(/\.rri-accordion__heading svg/g, '.rri-accordion__arrow')
