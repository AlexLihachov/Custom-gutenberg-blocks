 ...
 *
 * @param {Array} matchers An array of mathcer arrays. For example [ [ 'rri-cta__title', 'title' ] ]
 *                         This will listen for clicks on the element that has the class `rri-cta__title`
