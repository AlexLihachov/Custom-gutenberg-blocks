...
const ImageUploadPlaceholder = props => {
    ...
    const imageClass = classnames([
        className,
        'rri-image-upload-placeholder',
    ], {
        'rri-image-upload-has-image': imageURL,
        'rri-image-upload-has-placeholder': !imageURL,
    });
                    ...
                    return (
                        ...
                        >
                            {imageURL && onRemove && hasRemove && (
                                <button className="rri-image-upload-remove" onClick={ev => {
                                    onRemove();
                                    ev.stopPropagation()
