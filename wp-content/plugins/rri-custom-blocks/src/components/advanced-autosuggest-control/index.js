...
const renderSuggestion = suggestion => {
    return <div className="rri-autosuggest-option" data-value={suggestion.value}>{suggestion.label}</div>
};

const renderSectionTitle = section => {
    return <div className="rri--autosuggest-group">{section.title}</div>
};
    ...
    render() {
        ...
        return (
            <BaseControl
                ...
                className={classnames('rri-advanced-autosuggest-control', this.props.className)}
            >
                <BaseControlMultiLabel
                    label={this.props.label}
                    screens={this.props.screens}
                />
                <div className="rri-advanced-autosuggest-control__select" ref={this.autosuggestDiv}>
                    <Autosuggest
                    ...
                    />
                    {this.state.isEmpty && <div className="rri--autosuggest-empty">{this.props.noMatchesLabel}</div>}
                </div>
            </BaseControl>
        )
    }
