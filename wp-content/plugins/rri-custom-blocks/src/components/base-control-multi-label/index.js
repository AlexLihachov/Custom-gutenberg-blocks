 ...
 */
import {ResponsiveToggle} from '../../components';

const BaseControlMultiLabel = props => {
    return (
        <div className="rri-base-control-multi-label">
            <div className="rri-base-control-multi-label__label components-base-control__label">{props.label}</div>
            <ResponsiveToggle
                screens={props.screens}
                onChangeScreen={props.onChangeScreen}
            />
            <div className="rri-base-control-multi-label__units">
