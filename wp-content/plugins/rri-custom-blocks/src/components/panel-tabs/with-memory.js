 ...
 */
import {isUnmodifiedBlock} from '../../util';
...
const withMemory = createHigherOrderComponent(
	WrappedComponent => class extends Component {
		...
		getActiveTab() {
			const mainContainer = document.querySelector('.components-panel[data-rri-tab]');
			return mainContainer ? mainContainer.getAttribute('data-rri-tab') : undefined
		}

		getActiveTabPanelContainer(tab = this.getActiveTab()) {
			return tab ? document.querySelector(`.rri-panel-${tab}`) : undefined
		}
