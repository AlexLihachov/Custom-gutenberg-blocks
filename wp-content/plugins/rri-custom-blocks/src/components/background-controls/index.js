        ...
        <Fragment>
            {props.onChangeBackgroundColorType && (
                <BaseControl
                    ...
                    id="rri-background-color-type"
                    className="rri--help-tip-background-color-type"
                >
                    <AdvancedToolbarControl
                        controls={[
                            {
            ...
            >
                {props.onChangeBackgroundGradientDirection && (
                    <AdvancedRangeControl
                        ...
                        allowReset={true}
                        placeholder="90"
                        className="rri--help-tip-gradient-direction"
                    />
                )}
                ...
                {props.onChangeBackgroundGradientLocation1 && (
                    <AdvancedRangeControl
                        ...
                        allowReset={true}
                        placeholder="0"
                        className="rri--help-tip-gradient-location"
                    />
                )}
                ...
                {props.onChangeBackgroundGradientBlendMode && (
                    <BlendModeControl
                        ...
                        className="rri--help-tip-background-blend-mode"
                    />
                )}
            </ButtonIconPopoverControl>
            }
            ...
            (props.backgroundMediaURL || props.tabletBackgroundMediaURL || props.mobileBackgroundMediaURL) && (
                <AdvancedRangeControl
                    ...
                    className="rri--help-tip-background-tint"
                />
            )}
            ...
            !isBackgroundVideo() && (
                <ToggleControl
                    ...
                    className="rri--help-tip-background-fixed"
                />
            )}
            ...
            >
                ...
                <WhenResponsiveScreen>
                    <AdvancedSelectControl
                        ...
                        className="rri--help-tip-background-image-position"
                    />
                </WhenResponsiveScreen>
                <WhenResponsiveScreen screen="tablet">
                    <AdvancedSelectControl
                ...
                <WhenResponsiveScreen>
                    <AdvancedSelectControl
                        ...
                        className="rri--help-tip-background-image-repeat"
                    />
                </WhenResponsiveScreen>
                <WhenResponsiveScreen screen="tablet">
                    <AdvancedSelectControl
                ...
                <WhenResponsiveScreen>
                    <AdvancedSelectControl
                        ...
                        className="rri--help-tip-background-image-size"
                    />
                </WhenResponsiveScreen>
                <WhenResponsiveScreen screen="tablet">
                    <AdvancedSelectControl
