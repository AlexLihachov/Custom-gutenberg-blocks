...
const AdvancedToolbarControl = props => {
    ...
    const toolbarClasses = classnames( {
        'rri-toolbar--full-width': props.fullwidth,
        'rri-toolbar--multiline': props.multiline,
    } );

    return (
        <BaseControl
            help={ props.help }
            className={ classnames( 'rri-advanced-toolbar-control', props.className ) }
        >
            ...
            <Toolbar
                ...
                controls={ controls.map( option => {
                    return {
                        ...
                        extraProps: {
                            ...( ! option.icon ? { children: <span className="rri-advanced-toolbar-control__text-button">{ option.title }</span> } : {} ),
                        },
                    }
                } ) }
