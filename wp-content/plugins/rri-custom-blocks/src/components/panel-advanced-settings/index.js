...
import {scrollPanelIntoView} from '../../higher-order/with-click-open-inspector/util';
...
class PanelAdvancedSettings extends Component {
    ...
    render() {
        const mainClasses = classnames([
            ...
            'rri-toggle-panel-body--advanced': this.state.showAdvanced,
            [`rri-panel--${this.props.id}`]: this.props.id,
        });
        ...
        return (
                    ...
                    <Fragment>
                        {this.props.hasToggle && this.props.toggleAttributeName && (
                            <span className={`editor-panel-toggle-settings__panel-title`}>
								<FormToggle
                                    className="rri-toggle-panel-form-toggle"
            ...
            >
                ...
                {this.props.advancedChildren && (
                    <button
                        className="rri-panel-advanced-button"
