            ...
            >
                ...
                {props.onChangeFontWeight && (
                    <SelectControl
                        ...
                        className="rri--help-tip-typography-weight"
                    />
                )}
                {props.onChangeTextTransform && (
                    <SelectControl
                        ...
                        className="rri--help-tip-typography-transform"
                    />
                )}
                    ...
                    <Fragment>
                        <WhenResponsiveScreen>
                            <AdvancedRangeControl
                                ...
                                className="rri--help-tip-typography-line-height"
                            />
                        </WhenResponsiveScreen>
                        <WhenResponsiveScreen screen="tablet">
                            <AdvancedRangeControl
                ...
                {props.onChangeLetterSpacing && (
                    <AdvancedRangeControl
                        ...
                        placeholder="0"
                        className="rri--help-tip-typography-letter-spacing"
                    />
                )}
            </ButtonIconPopoverControl>
