...
class FourRangeControl extends Component {
	...
	render() {
		...
		const id = `rri-four-range-control-${instanceId}__item-`
		const propsToPass = {
			min: this.props.min,
			max: this.props.max,
		...
		const lockClassNames = classnames([
			'rri-four-range-control__lock',
		], {
			'rri--is-locked': this.state.locked,
		})
		...
		return (
			<BaseControl
				...
				className={classnames('rri-four-range-control', this.props.className)}
			>
				...
				/>
				{this.state.locked &&
				<div className="rri-four-range-control__range">
					{

						/* <Tooltip text={ allLabel }>
							<span className="rri-four-range-control__icon">{ allIcon }</span>
						</Tooltip> */
					}
					<RangeControl
						id={`${id}-all`}
				...
				<Fragment>
					...
					<div className="rri-four-range-control__range">
						<Tooltip text={__('Top', i18n)}>
							<span className="rri-four-range-control__icon"><SVGTopImage/></span>
						</Tooltip>
						<RangeControl
							id={`${id}-top`}
					...
					<div className="rri-four-range-control__range">
						<Tooltip text={__('Right', i18n)}>
							<span className="rri-four-range-control__icon"><SVGRightImage/></span>
						</Tooltip>
						<RangeControl
							id={`${id}-right`}
					...
					<div className="rri-four-range-control__range">
						<Tooltip text={__('Bottom', i18n)}>
							<span className="rri-four-range-control__icon"><SVGBottomImage/></span>
						</Tooltip>
						<RangeControl
							id={`${id}-bottom`}
					...
					<div className="rri-four-range-control__range">
						<Tooltip text={__('Left', i18n)}>
							<span className="rri-four-range-control__icon"><SVGLeftImage/></span>
						</Tooltip>
						<RangeControl
							id={`${id}-left`}
