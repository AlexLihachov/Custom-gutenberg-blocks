	...
	return (
		<Fragment>
			...
			<PanelAdvancedSettings
				...
				id="block-title"
				className="rri-panel-block-title-module"
			...
			>
				...
				>
					<AlignButtonsControl
						label={__('Align', i18n)}
						className="rri--help-tip-alignment-description"
					/>
				</ResponsiveControl>
			</PanelAdvancedSettings>
		</Fragment>
...
const addAttributes = attributes => {
	return {
		...
		blockDescription: {
			source: 'html',
			selector: '.rri-block-description',
...
const addTitleEditOutput = (output, design, props) => {
	...
	const titleClasses = classnames([
		...
		'rri-block-title--with-subtitle': showBlockDescription && blockDescription,
	})
		...
		<Fragment>
			...
			{showBlockDescription && (
				<RichText
					...
					className="rri-block-description"
			...
			{showBlockTitle && (
				...
				>
					<AdvancedRangeControl
						...
						max={100}
						allowReset={true}
						className="rri--help-tip-spacing-block-title"
					/>
				</ResponsiveControl>
			)}
			{showBlockDescription && (
				...
				>
					<AdvancedRangeControl
						...
						max={100}
						allowReset={true}
						className="rri--help-tip-spacing-block-description"
					/>
				</ResponsiveControl>
			)}
		</Fragment>
