	...
	return (
		<Fragment>
			...
			<PanelAdvancedSettings
				...
				className="rri--help-tip-background-on-off"
			>
				<BackgroundControlsHelper
...
const addBlockAlignClasses = ( classes, props ) => {
	...
	return {
		...classes,
		[ `rri-main-block--inner-${ blockInnerWidth }` ]: blockInnerWidth,
		'rri--has-block-background': showBlockBackground,
		// Class copied from DivBackground component.
		'rri--has-background-overlay': hasBackgroundOverlay( 'blockBackground%s', props.attributes ),
	}
}
